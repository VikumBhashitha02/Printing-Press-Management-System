...
const ProductDetail = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((result) => {
        ...
        // Fetch image data if imageName or imagePath exists
        if (result.data.product.imageName || result.data.product.imagePath) {
          const imageUrl = result.data.product.imageName
            ? `http://localhost:5000/products/images/${result.data.product.imageName}`
            : result.data.product.imagePath; // Adjust the URL or field based on your actual API response
  ...
  return (
    <>
      <PageTopBanner title={product.pname} path="/shop" />
        ...
        <div className="container px-4 px-lg-5 mt-5">
          ...
          <div className="row">
            <div className="col-lg-6">
              <img
                src={`http://localhost:5000/products/images/${product.imageName}`} // Adjust URL as per your backend setup
                alt={product.pname}
            ...
            <div className="col-lg-6">
              ...
              <br />
              <Link
                to={`/tell-us-more?productId=${productId}&quantity=${selectedQuantity}&totalAmount=${totalPrice}`}
              >
